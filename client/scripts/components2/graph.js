define(['lib/clib', 'lib/lodash'], function(Clib, _) {
    ...
    function Graph(width, height) {
        ...
        this.YAxisInitialPlotValue = "cero"; //"cero", "betSize"
    };
    ...
    Graph.prototype.setData = function(ctx, canvas, engine) {
        ...
        //this.crashedAt = crashedAt; //Text displaying the crashed ammount
        //this.currentCash = currentCash; // Text displaying the current payout

        //this.playersCashedOut = playersCashedOut; //Array to render circles in the players cashout positions
    ...
    Graph.prototype.drawGraph = function() {
        ...
        for(var t=0, i=0; t <= this.currentTime; t+= 100, i++) {
            ...
            /* Graph */
            var payout = this.engine.calcGamePayout(t)-1; //We start counting from one x
